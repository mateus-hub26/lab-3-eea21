...
Na etapa de simula\c{c}\~ao, foi solicitado projetar um circuito capaz de multiplicar dois n\'umeros de 2 bits, gerando um produto de 4 bits. O relat\'orio deve conter o desenvolvimento do esquem\'atico, as equa\c{c}\~oes obtidas e o diagrama de temporiza\c{c}\~ao referente aos casos pedidos no roteiro.
